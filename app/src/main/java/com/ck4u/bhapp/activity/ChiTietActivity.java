...
public class ChiTietActivity extends AppCompatActivity {
    ...
    private void initControl() {
        ...
        btnYoutube.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent clickYoutube = new Intent(getApplicationContext(), YouTubeActivity.class);
                clickYoutube.putExtra("linkvideo", sanPhamMoi.getLinkvideo());
                startActivity(clickYoutube);
            }
        });
    }
