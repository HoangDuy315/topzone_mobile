...
import com.ck4u.bhapp.Interface.IImageClickListener;
import com.ck4u.bhapp.R;
import com.ck4u.bhapp.model.EventBus.TinhTongEvent;
import com.ck4u.bhapp.model.GioHang;
            ...
            public void onImageClick(View view, int pos, int giatri) {
                if(giatri == 1) {
                    if(gioHangList.get(pos).getSoluong() > 1) {
                        ...
                        holder.item_giohang_giasp2.setText(decimalFormat.format(gia));
                        // ham tinhtongtien ben giohangactivity dang la private nen phai bat them su kien chuyen qua ham tinhtongtien
